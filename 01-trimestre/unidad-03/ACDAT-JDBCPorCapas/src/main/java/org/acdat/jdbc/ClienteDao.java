...
public class ClienteDao {
    public List<Cliente> mostrarClientes(Connection connection) throws SQLException{
    ...
    public void crearTablaCliente(Connection connection){
    ...
    public void eliminarTablaCliente(Connection connection){

package org.example.entidadesjpa;

import jakarta.persistence.*;

@Entity
@Table(name = "empleados", schema = "public", catalog = "empleados")
public class Empleadosentidadesjpa {
    private int id;
    private String nif;
    ...
    private Departamentosentidadesjpa departamentosByIdDepartamento;
    ...
    public boolean equals(Object o) {
        ...
        Empleadosentidadesjpa that = (Empleadosentidadesjpa) o;
    ...
    public Departamentosentidadesjpa getDepartamentosByIdDepartamento() {
        return departamentosByIdDepartamento;
    }

    public void setDepartamentosByIdDepartamento(Departamentosentidadesjpa departamentosByIdDepartamento) {
